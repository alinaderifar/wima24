...
return [
    ...
    | Default URIs
    |--------------------------------------------------------------------------
    | Homepage and countries list page
    */
    'default_uri'        => '/',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Use the country's ISO Code (e.g., 'BJ' for Benin)
    | Leave empty to allow user to select a country if IP not found
    | or if the IP belongs to a banned country.
    */
    'default_country'    => '',
